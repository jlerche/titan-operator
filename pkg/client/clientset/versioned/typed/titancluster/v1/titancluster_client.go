...
import (
	...
	"github.com/jlerche/titan-operator/pkg/client/clientset/versioned/scheme"
...
func (c *FooV1Client) TitanClusters(namespace string) TitanClusterInterface {
	return newTitanClusters(c, namespace)
}
